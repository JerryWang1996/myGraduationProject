...
-- description为仓库描述
-- assignTime表示管理员将仓库分配给某个用户的时间点
-- rentStartTime表示用户缴纳租金的开始日期
-- rentEndTime表示用户所租仓库到期日期
...
CREATE TABLE `room` (
  ...
  `rentStartTime` varchar(255) DEFAULT NULL,
  `rentEndTime` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
